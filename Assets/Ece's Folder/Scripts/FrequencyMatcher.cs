...
public class FrequencyManager : MonoBehaviour
{
    ...
    public RawImage[] currentFrequencyImages;  // Üstte deðiþen frekanslar

    [Header("Frequencies")]
    public Texture[] frequencyTextures;        // Tüm frekans resimleri (3 farklý olmalý)

    [Header("Feedback")]
    public RawImage[] feedbackImages;         // Feedback için RawImage'ler
    public Texture tickTexture;               // Inspector'a sürüklenecek Texture
    public Texture crossTexture;              // Inspector'a sürüklenecek Texture
    ...
    void Start()
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            // Baþlangýçta farklý frekans ata
            do
            {
